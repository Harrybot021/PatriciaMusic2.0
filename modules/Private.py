...
def _start(client, message):
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup([[
            ...
            InlineKeyboardButton("🛠 Source Code 🛠", url=f"https://github.com/TEAM-PATRICIA/PatriciaMusic2.0") 
          ]]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '🛠 Source Code 🛠', url=f"https://github.com/TEAM-PATRICIA/PatriciaMusic2.0)],
